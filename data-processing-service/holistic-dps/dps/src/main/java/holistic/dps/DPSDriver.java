 ...
 */
public class DPSDriver extends Configured implements Tool {

	@Override
	public int run(String[] args) throws Exception {
		Configuration config = new Configuration();
		
		JobConf jobConf = new JobConf(config, DPSDriver.class);
	...
	private Job getJob(JobConf jobConfig) throws IOException {
		Job job = Job.getInstance(jobConfig, "DPS Job - Data Aggregation");
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new DPSDriver(), args);
